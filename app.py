...
face_cacade = cv2.CascadeClassifier(
    "face and object detection/haarcascade_frontalface_default.xml"
)
eyes_cascade = cv2.CascadeClassifier(
    "face and object detection/haarcascade_eye.xml"
)
smile_cascade = cv2.CascadeClassifier(
    "face and object detection/haarcascade_smile.xml"
)
eye_glasses_cascade = cv2.CascadeClassifier(
    "face and object detection/haarcascade_eye_tree_eyeglasses.xml"
)
